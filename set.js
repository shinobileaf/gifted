...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~T3hH3aaK#7w0WxHk6BTJV0v6Xm3qnb1YDTEtJZpXa-VXM7Tr_3IA", // Add sess Id here especially when deploying on panels else use app.json and .env file...
